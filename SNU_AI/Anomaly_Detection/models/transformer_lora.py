...
class MultiHeadAttentionLayer(nn.Module):
    def __init__(self, d_embed, n_head, r, max_seq_len=512, relative_position_embedding=True):
        ...
        self.word_fc_layers = clone_layer(lora.Linear(d_embed, d_embed, r=r), 3)
...
def get_transformer_encoder(d_embed=512,
    ...
    attention_layer = MultiHeadAttentionLayer(d_embed, n_head, rank, max_seq_len, relative_position_embedding)
