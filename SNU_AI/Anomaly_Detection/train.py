...
def main(args):
    ...
    if args.checkpoint is not None: # for transfer learning
        ...
        options.network = prev_options.network
    ...
    model = get_anomaly_transformer(options=options.network,
                                    ...
                                    transformer_n_head=8).to(device)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--options", default='./configs/train_base_config.yaml')
