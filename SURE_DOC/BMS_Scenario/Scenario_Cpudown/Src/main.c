...
void StartMyTask02(void const * argument);
...
int main(void)
{
  ...
  osThreadDef(MyTask1, StartMyTask1, osPriorityNormal, 0, 2048);
  MyTask1Handle = osThreadCreate(osThread(MyTask1), NULL);

#if 0
  /* definition and creation of MyTask02 */
  osThreadDef(MyTask02, StartMyTask02, osPriorityIdle, 0, 1024);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, GPIO_PIN_12|LD3_Pin|LD5_Pin|LD6_Pin, GPIO_PIN_RESET);
...
/* USER CODE BEGIN Header_StartMyTask02 */
/**
* @brief Function implementing the MyTask02 thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartMyTask02 */
void StartMyTask02(void const * argument)
{
...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
  ...
  {
	  count = (HAL_RNG_GetRandomNumber(&hrng) % 1000000);
	  normal_count++;
  }
  if(normal_count > 10000000)
  {
	  if(count >999998)
	  {
