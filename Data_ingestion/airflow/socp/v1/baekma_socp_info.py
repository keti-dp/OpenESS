...
LOAD_DATA_PATH = "/home/jpark/airflow/dags/calc_socp/dataset/baekma/"
PERIOD_DATA_PATH = "/home/jpark/airflow/dags/calc_socp/dataset/baekma/info/period_dataset/"
PREP_DATA_PATH = "/home/jpark/airflow/dags/calc_socp/dataset/baekma/info/prep_dataset/"
...
def get_dataset(inf, **context):
    ...
    for date in date_range:
        try:
            df = pd.read_parquet(LOAD_DATA_PATH + date + ".parquet")
    ...
    for bank in bank_list:
        ...
        for rack in rack_list:
            ...
            query_rack_df.to_parquet(PERIOD_DATA_PATH + f_name + "/" + file_name + ".parquet")
...
with DAG(dag_id='baekma_SoCP_info',
