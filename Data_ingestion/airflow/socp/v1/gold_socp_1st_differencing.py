...
SAVE_DATA_PATH = "/home/jpark/airflow/dags/calc_socp/dataset/gold/count/diff/"
...
with DAG(dag_id='gold_SoCP_1st_differencing',
    ...
    push_data = PythonOperator(
        ...
        op_kwargs={
            "table_name": "ess_socp_count_diff_oper3",
            "file": "{{ task_instance.xcom_pull(task_ids='getDataset', key='f_name')}}"
        }
    )
