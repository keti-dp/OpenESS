...
ORI_DATA_PATH = "/home/jpark/airflow/dags/calc_socp/dataset/gold/"
WORK_DATA_PATH = "/home/jpark/airflow/dags/calc_socp/dataset/gold/count/work_data/"
PREP_DATA_PATH = "/home/jpark/airflow/dags/calc_socp/dataset/gold/count/prep_data/"
PERIOD = 1
SITE_NAME = "gold"
...
with DAG(dag_id='gold_SoCP_count',
    ...
    save_database = PythonOperator(
        ...
        op_kwargs={
            "table_name": "ess_socp_count_oper3"
        }
    )
    ...
    trigger_differencing = TriggerDagRunOperator(
        ...
        trigger_dag_id = "gold_SoCP_1st_differencing",
        execution_date = "{{ execution_date }}"
    )

    trigger_moving_average = TriggerDagRunOperator(
        task_id = "trigger_moving_average",
        trigger_dag_id = "gold_SoCP_moving_average",
        execution_date = "{{ execution_date }}"
    )
