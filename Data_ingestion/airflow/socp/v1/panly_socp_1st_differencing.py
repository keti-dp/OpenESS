...
SAVE_DATA_PATH = "/home/jpark/airflow/dags/calc_socp/dataset/panly/count/diff/"
...
with DAG(dag_id='panly_socp_1st_differencing',
    ...
    push_data = PythonOperator(
        ...
        op_kwargs={
            "table_name": "ess_socp_count_diff_oper2",
            "file": "{{ task_instance.xcom_pull(task_ids='getDataset', key='f_name')}}"
        }
    )
