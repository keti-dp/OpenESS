...
ORI_DATA_PATH = "/home/jpark/airflow/dags/calc_socp/dataset/panly/"
WORK_DATA_PATH = "/home/jpark/airflow/dags/calc_socp/dataset/panly/count/work_data/"
PREP_DATA_PATH = "/home/jpark/airflow/dags/calc_socp/dataset/panly/count/prep_data/"
PERIOD = 1
SITE_NAME = "panly"
...
def prep_dataset(**context):
    ...
    df = pd.read_feather(ORI_DATA_PATH + load_file_name + ".feather")
...
with DAG(dag_id='panly_count_socp',
    ...
    save_database = PythonOperator(
        ...
        op_kwargs={
            "table_name": "ess_socp_count_oper2"
        }
    )
    ...
    trigger_differencing = TriggerDagRunOperator(
        ...
        trigger_dag_id = "panly_socp_1st_differencing",
        execution_date = "{{ execution_date }}"
    )

    trigger_moving_average = TriggerDagRunOperator(
        task_id = "trigger_moving_average",
        trigger_dag_id = "panly_socp_moving_average",
        execution_date = "{{ execution_date }}"
    )
