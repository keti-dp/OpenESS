...
def calc_health_indicator_partial_energy(**context):
    ...
    for bank_id in list(df["BANK_ID"].unique()):
        ...
        for rack_id in list(bank_df["RACK_ID"].unique()):          
            ...
            rack_pe_df = bank_df.query(f"RACK_ID == {rack_id} and BATTERY_STATUS_FOR_RUN == 1 and BATTERY_STATUS_FOR_CHARGE == 2").reset_index(drop=True)
...
with DAG(dag_id='baekma_HI_calc_PE',
