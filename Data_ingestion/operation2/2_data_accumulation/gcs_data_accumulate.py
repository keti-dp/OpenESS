...
def csv_export(tablename):
    ...
    fields_query = """select column_name from information_schema.columns where table_catalog = 'ESS_Operating_Site2' and table_name = '{_table}' order by ordinal_position;""".format(
        _table=tablename
    )
