...
class timescale:
    ...
    def __init__(self, ip, port, username, password, dbname):
        ...
        if dbname == "ESS_Operating_Site1":
            operatingsite = "operation1"
        elif dbname == "ESS_Operating_Site2":
            operatingsite = "operation2"

        connection_logger = logs.get_logger(
            operatingsite, "/home/keti_iisrc/test/log/", operatingsite + ".json"
        )
        ...
        try:
            ...
            connection_logger.error("Connection error : %s", ip)
    ...
    def Bank_input_data(self, datetime, input_list, operation_site):
        ...
        try:
            ...
            print(error.pgerror)
            input_logger.error("Bank data input error : %s", error.pgerror)
        self.conn.commit()
        cursor.close()
    ...
    def Rack_input_data(self, datetime, input_list, operation_site):
        ...
        for Rack in Rack_data:
            try:
                ...
                print(error.pgerror)
                input_logger.error("Rack data input error : %s", error.pgerror)
        self.conn.commit()
        cursor.close()
    ...
    def PCS_input_data(self, datetime, input_list, operation_site):
        ...
        try:
            ...
            print(error.pgerror)
            input_logger.error("PCS data input error : %s", error.pgerror)
        self.conn.commit()
        cursor.close()
    ...
    def ETC_input_data(self, datetime, input_list, operation_site):
        ...
        try:
            ...
            print(error.pgerror)
            input_logger.error("ETC data input error : %s", error.pgerror)
        self.conn.commit()
        cursor.close()
